...
var ensureCreated = function () { return __awaiter(void 0, void 0, void 0, function () {
    var i;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _a.label = 1;
            case 1:
                if (!(i < 101)) return [3 /*break*/, 5];
                return [4 /*yield*/, model.findOne({ code: i })];
            case 2:
...
exports.default = { TestModel: model, EnsureEntities: ensureCreated };
