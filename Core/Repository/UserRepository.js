...
var CrudRepository_1 = __importDefault(require("./CrudRepository"));
var bcrypt = __importStar(require("bcrypt"));
var UserRepository = /** @class */ (function (_super) {
    __extends(UserRepository, _super);
    function UserRepository(MongooseModel, getPopulates, listPopulates) {
    ...
    UserRepository.prototype.beforeInsert = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, copyData];
            });
        });
    };
    return UserRepository;
}(CrudRepository_1.default));
